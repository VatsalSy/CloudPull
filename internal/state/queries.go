...
type SessionProgress struct {
  ...
  TransferRate        float64   `db:"transfer_rate" json:"transfer_rate"` // bytes per second
  EstimatedCompletion float64   `db:"estimated_completion" json:"estimated_completion"` // seconds remaining
}
